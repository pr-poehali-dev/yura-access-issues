...
const services = [
  { icon: 'HeartHandshake', title: 'Индивидуальная терапия', text: 'Работа с тревогой, выгоранием и поиском опоры внутри себя.' },
  { icon: 'Users', title: 'Семейные консультации', text: 'Восстановление тепла и понимания в отношениях с близкими.' },
  { icon: 'Sparkles', title: 'Работа с самооценкой', text: 'Бережный путь к принятию себя и внутренней устойчивости.' },
  { icon: 'CloudRain', title: 'Кризисная поддержка', text: 'Сопровождение в моменты потерь, перемен и сильных переживаний.' },
];
