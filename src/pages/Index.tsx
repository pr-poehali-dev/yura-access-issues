      ...
      <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-md bg-background/70 border-b border-border">
        <div className="container flex items-center justify-between h-20">
          <button onClick={() => scrollTo('home')} className="font-serif text-2xl tracking-tight flex flex-col items-start leading-tight">
            ...
            <span className="font-hand text-lg text-muted-foreground font-normal" style={{ transform: 'rotate(-3deg)', display: 'inline-block', transformOrigin: 'left center' }}>Бережная терапия</span>
          </button>
